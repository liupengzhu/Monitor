...
public class SteamRecyclerAdapter extends RecyclerView.Adapter<SteamRecyclerAdapter.ViewHolder> {
    private Context context;
    private List<SteamBean> steamBeanList = new ArrayList<>();

    public SteamRecyclerAdapter(Context context, List<SteamBean> steamBeanList) {
        this.context = context;
        this.steamBeanList = steamBeanList;
    }
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            time = itemView.findViewById(R.id.steam_item_date);
            total = itemView.findViewById(R.id.steam_item_total);
            history_average = itemView.findViewById(R.id.steam_item_history_average);
            range = itemView.findViewById(R.id.steam_item_range);
            totalUnit = itemView.findViewById(R.id.steam_item_total_unit);
            history_averageUnit = itemView.findViewById(R.id.steam_item_history_average_unit);
            history_averageLayout = itemView.findViewById(R.id.steam_item_history_average_layout);
            rangeLayout = itemView.findViewById(R.id.steam_item_range_layout);
            rangeImg = itemView.findViewById(R.id.steam_item_range_img);
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_steam_recycler, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(ViewHolder holder, int position) {
        SteamBean bean = steamBeanList.get(position);

        holder.totalUnit.setText("区间用汽量 (" + bean.getRatio() + ")");
